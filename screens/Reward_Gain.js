...
export default class Welcome extends React.Component {
  render() {
    ...
    return (<Block middle> <Block space="between" style={styles.circle_container}>
      <Block middle> <Text h4 style={{ fontFamily: 'montserrat-bold', marginTop: 70, fontSize: 28, fontWeight: 'bold' }}
                           color={theme.COLORS.BLACK}> 500 </Text> <Text h4 style={{
        fontFamily: 'montserrat-bold', fontSize: 28,
        fontWeight: 'bold'
      }} color={theme.COLORS.BLACK}> Asian Miles </Text> </Block> </Block> <Block space="between"
                                                                                  style={styles.circle_container2}>
      <Block middle> <Text h4 style={{ fontFamily: 'montserrat-bold', marginTop: 70, fontSize: 28, fontWeight: 'bold' }}
                           color={theme.COLORS.BLACK}> HKD 500 </Text> <Text h4 style={{
        fontFamily: 'montserrat-bold',
        fontSize: 28,
        fontWeight: 'bold'
      }} color={theme.COLORS.BLACK}> Cash Reward </Text> </Block> </Block> </Block>);
  }
}
const styles = StyleSheet.create({
  ...
  container: { backgroundColor: nowTheme.COLORS.BACKGROUND, marginTop: Platform.OS === 'android' ? -HeaderHeight : 0
